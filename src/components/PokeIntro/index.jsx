        ...
        <Grid item xs={12}>
          <Paper className={classes.paper}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={4}>
                <img alt={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${id}.png`} src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${id}.png`} className={classes.sprite} />
              </Grid>
              <Grid item xs={4} className={classes.iconContainer}>
